...
CREATE OR REPLACE FUNCTION EXCLUIR_TUTOR(CPF_TUTOR VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
	...
	DELETE FROM TUTOR
	WHERE COD_TUTOR = COD_TUTOR_BUSCADO;
END;
$$ LANGUAGE PLPGSQL;
...
SEXO_PET VARCHAR, CPF_TUTOR VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
	...
	INSERT INTO PET (NOME, DT_NASC, ESPECIE, PORTE, SEXO, COD_TUTOR)
	VALUES (NOME_PET, DT_NASC_PET, ESPECIE_PET, PORTE_PET, SEXO_PET, COD_TUTOR_BUSCADO);
...
CREATE OR REPLACE FUNCTION EXCLUIR_PET(NOME_PET VARCHAR, CPF_TUTOR VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION EXCLUIR_PLANO_PET(NOME_PLANO_PET VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
	...
	WHERE COD_PLANO_PET = COD_PLANO_PET_BUSCADO;
END;
$$ LANGUAGE PLPGSQL;
...
CREATE OR REPLACE FUNCTION EXCLUIR_ATENDENTE(NOME_ATEND VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
	...
	WHERE COD_ATEND = COD_ATEND_BUSCADO;
END;
$$ LANGUAGE PLPGSQL;
...
CREATE OR REPLACE FUNCTION EXCLUIR_VETERINARIO(CRMV_VET VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION EXCLUIR_ESPECIALIDADE(NOME_ESPECIALIDADE VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
	COD_ESP_BUSCADO INT;
BEGIN
	COD_ESP_BUSCADO := (SELECT BUSCAR_COD_ESP(NOME_ESPECIALIDADE));

	DELETE FROM ESPECIALIDADE
	WHERE COD_ESP = COD_ESP_BUSCADO;
END;
$$ LANGUAGE PLPGSQL;
...
CREATE OR REPLACE FUNCTION EXCLUIR_FARMACO(NOME_FARM VARCHAR)
RETURNS VOID
SECURITY DEFINER
AS $$
DECLARE
...
BEGIN
	COD_FARM_BUSCADO := (SELECT BUSCAR_COD_FARM(NOME_FARM));
