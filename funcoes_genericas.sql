...
BEGIN
    ...
    ELSIF NOME_TABELA ILIKE 'PET' THEN
        ...
        VALUES (VALOR1, CAST(VALOR2 AS DATE), VALOR3, VALOR4, VALOR5, CAST(VALOR6 AS INT));
    ...
    ELSIF NOME_TABELA ILIKE 'CONSULTA' THEN
        ...
        VALUES (CAST(VALOR1 AS DATE), CAST(VALOR2 AS TIME), VALOR3, CAST(VALOR4 AS INT), CAST(VALOR5 AS INT), CAST(VALOR6 AS INT), CAST(VALOR7 AS INT), CAST(VALOR8 AS INT));
    ...
    ELSIF NOME_TABELA ILIKE 'VACINACAO' THEN
        ...
        VALUES (CAST(VALOR1 AS DATE), CAST(VALOR2 AS TIME), CAST(VALOR3 AS INT), CAST(VALOR4 AS INT), CAST(VALOR5 AS INT), CAST(VALOR6 AS INT), CAST(VALOR7 AS INT));
