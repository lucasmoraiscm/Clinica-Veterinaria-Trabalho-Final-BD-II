...
CREATE OR REPLACE TRIGGER TRIGGER_VERIFICAR_ITEM_MEDICACAO
BEFORE INSERT OR UPDATE OR DELETE ON ITEM_MEDICACAO
FOR EACH ROW EXECUTE FUNCTION VERIFICAR_ITEM_MEDICACAO();
